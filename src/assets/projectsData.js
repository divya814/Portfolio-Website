export const projectsData = [
    {
        ...
        projectDescription:
            'A Portfolio website is something which tells about you, your skills, projects and experience in an attractive way which also show cases your development skills!',
...

    {
        projectName: 'Name It!',
        projectDescription:
            'Check out my cool name suggestion application which will help you find the best name for your next project, venture, or startup. Keep building!',
